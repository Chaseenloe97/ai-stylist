      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-16 text-center">
          <div className="inline-block mb-6">
            <div className="w-20 h-20 mx-auto mb-4 bg-ink-900 flex items-center justify-center">
              <span className="text-4xl text-gold-400 font-serif italic">V</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-ink-700 mb-8 max-w-2xl mx-auto font-light tracking-wide animate-slide-up">
            Your Personal Style Curator
          </p>

          <div className="w-24 h-[2px] bg-gradient-to-r from-transparent via-gold-400 to-transparent mx-auto mb-12"></div>

          {!styleResult ? (
            <div className="animate-slide-up">
              <p className="text-ink-600 mb-12 max-w-xl mx-auto leading-relaxed">
              ...
              <div className="max-w-3xl mx-auto mb-12">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <button
                    ...
                    className="group card-luxury p-8 text-left hover:shadow-lg transition-all duration-300 disabled:opacity-50"
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-serif text-xl font-bold mb-2 group-hover:text-gold-600 transition-colors">
                          Connect Instagram
                        </h3>
                  ...
                  <button
                    ...
                    className="group card-luxury p-8 text-left hover:shadow-lg transition-all duration-300"
                  >
                    <div className="flex items-start space-x-4">
                      <div className="w-14 h-14 bg-ink-900 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="card-luxury p-8 mb-8">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h3 className="font-serif text-2xl font-bold mb-1">Your Style Library</h3>
                      ...
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="text-sm text-ink-600 hover:text-gold-600 transition-colors font-medium"
                        >
                    ...
                    {/* Gallery Grid */}
                    <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 ${!showGallery && uploadedImages.length > 8 ? 'max-h-96 overflow-hidden relative' : ''}`}>
                    ...
                    <label className="mt-6 block">
                      <div className="border-2 border-dashed border-ink-900/20 hover:border-gold-400 transition-all duration-300 p-8 text-center cursor-pointer group">
                        <svg className="w-10 h-10 mx-auto mb-3 text-ink-900/40 group-hover:text-gold-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
                        </svg>
                        <p className="text-sm text-ink-600 font-light">Add more photos to your library</p>
                      </div>
                      <input
                        type="file"
                        className="hidden"
              ...
              <div className="mt-16 pt-12 border-t border-cream-200">
                <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
                  <div className="text-center">
                    ...
                    <h3 className="font-serif text-lg mb-2">Private & Secure</h3>
                    <p className="text-sm text-ink-600 font-light">All analysis happens locally on your device</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl mb-3">✨</div>
                    <h3 className="font-serif text-lg mb-2">AI-Powered</h3>
                    <p className="text-sm text-ink-600 font-light">Advanced algorithms curate your unique style</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl mb-3">🎨</div>
                    <h3 className="font-serif text-lg mb-2">Comprehensive Analysis</h3>
                    <p className="text-sm text-ink-600 font-light">Every image informs your unique style profile</p>
                  </div>
                </div>
              </div>
            </div>
